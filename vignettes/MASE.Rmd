...
$$
y_{i} = \beta_{o} + \beta_{1}x_{i1} + \beta_{2}x_{i2} + ... + \beta_{p}x_{ip} +          \epsilon_{i} \\
...
$$
The logistic model results in probabilities between 0 and 1. The following code calculates GREG for our categorical $y$ variable, awards, in our srs and strat sample datasets using the mase package:
```{r}
# GREG applied to simple random sample
