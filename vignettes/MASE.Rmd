...
$$
where the summation extends to all the samples in the stratum $h$ of our sample, and $n_h$ is the population of the stratum $h$. Note that the non-capitalized $n$ stands for population size of the sample. @wil109
...
greg_strat <- greg(y = apistrat$api00, 
