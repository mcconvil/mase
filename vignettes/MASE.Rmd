...
When $y$ is categorical, GREG is a logistic regression. The following code calculates GREG for our categorical $y$ variable, awards, in our srs and strat sample datasets using the mase package:
```{r}
# GREG applied to simple random sample
...
# GREG applied to stratified sample
greg_logistic_strat <- greg(y = apistrat$api00, 
