...
greg_linear_srs <- greg(y = apisrs$api00, 
                        xsample = apisrs[c("col.grad", "awards", "snum", 
                                           "dnum", "cnum", "pcttest", 
                                           "meals", "sch.wide")],
                        xpop = apipop[c("col.grad", "awards", 
                                        "snum", "dnum", "cnum", "pcttest", 
                                        "meals", "sch.wide")], 
...
greg_lin_strat <- greg(y = apistrat$api00, 
                      xsample = apistrat[c("col.grad", "awards", "snum", 
                                           "dnum", "cnum", "pcttest", 
                                           "meals", "sch.wide")],
                      xpop = apipop[c("col.grad", "awards", 
                                      "snum", "dnum", "cnum", "pcttest", 
...
greg_logistic_srs <- greg(y = apisrs$new_awards, 
                          xsample = apisrs[c("col.grad", "snum", "dnum",
                                             "cnum", "pcttest", "meals",
                                             "new_sch.wide")],
                          xpop = apipop[c("col.grad", "snum", "dnum", "cnum", 
                                          "pcttest", "meals", "new_sch.wide")], 
                          pi = apisrs$pw^(-1), model = "logistic", var_est = TRUE)

greg_logistic_srs

# GREG applied to stratified sample
greg_logistic_strat <- greg(y = apistrat$new_awards, 
                          xsample = apistrat[c("col.grad", "snum", "dnum",
                                             "cnum", "pcttest", "meals",
                                             "new_sch.wide")],
                          xpop = apipop[c("col.grad", "snum", "dnum", "cnum", 
                                          "pcttest", "meals", "new_sch.wide")], 
...
gregE_lin_srs <- gregElasticNet(y = apisrs$api00, 
                                xsample = apisrs[c("col.grad", "awards", 
                                                   "snum", "dnum", "cnum", 
                                                   "pcttest", "meals", "sch.wide")],
                                xpop = apipop[c("col.grad", "awards", "snum", 
                                                "dnum", "cnum", "pcttest", 
                                                "meals", "sch.wide")], 
...
gregE_lin_strat <- gregElasticNet(y = apistrat$api00, 
...
gregE_log_srs <- gregElasticNet(y = apisrs$new_awards, 
                                xsample = apisrs[c("col.grad", "snum", "dnum",
                                                   "cnum", "pcttest", "meals", 
                                                   "new_sch.wide")],
                                xpop = apipop[c("col.grad", "snum", "dnum",
                                                "cnum", "pcttest", "meals", 
                                                "new_sch.wide")], 
                                pi = apisrs$pw^(-1), alpha = 0.5, 
...
gregE_log_strat <- gregElasticNet(y = apistrat$new_awards, 
                                xsample = apistrat[c("col.grad", "snum", "dnum",
                                                     "cnum", "pcttest", "meals", 
                                                     "new_sch.wide")],
                                xpop = apipop[c("col.grad", "snum", "dnum",
