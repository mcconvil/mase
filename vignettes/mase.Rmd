...
#Horvitz-Thompson Estimator and its variance (general and SRS)
 ...
 $$
 Var(\hat{t}_{y}) = \sum _{i = 1} ^N \sum _{j= 1}^N (\frac{\pi_{ij} - \pi_i\pi_j}{\pi_i \pi_j}) y_i y_j,
 $$
 so the logical estimate is
 $$
 \hat{Var}(\hat{t}_{y}) = \sum _{i = 1} ^n \sum _{j= 1}^n (\frac{\pi_{ij} - \pi_i\pi_j}{\pi_i \pi_j \pi _{ij}}) \hat{y}_i \hat{y}_j
 $$
 
 Note that the joint inclusion probabilities are usually difficult to come by, 
