...
```{r}
explor_quant <- apisrs[,c(12, 20:25)]
pairs(explor_quant)
```
...
re_srs_r <- ratioEstimator(y = apisrs$api00, var_est = FALSE, )
re_srs_r <- ratioEstimator(y = apisrs$api100, xsample = apisrs$meals, xpop = apisrs$meals, datatype = "raw", pi = NULL, N = NULL, pi2 = NULL, var_est = FALSE, var_method = "HB", B = 1000)
#Returns error of: argument is not a matrix
```
